...
import { products, relatedProducts } from "@/lib/constants"
...
export default function ProductDetailPage({ params }: { params: { id: string } }) {
    ...
    const { getApprovedProductReviews, getAverageRating } = useReview()
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <ProductRating rating={averageRating} reviews={reviews.length} />
                            </div>
                        ...
                        <Tabs defaultValue="description">
                            ...
                            <TabsContent value="reviews" className="pt-6">
                                <div className="space-y-8">
                                    {/* Reviews List */}
                                    <ReviewList productId={productId} limit={5} />

                                    {/* Review Form */}
                                    <div className="border-t pt-8">
                                        <h3 className="font-medium mb-4">Viết đánh giá của bạn</h3>
                                        {!showReviewForm ? (
                                            <Button onClick={() => setShowReviewForm(true)} className="bg-pink-500 hover:bg-pink-600">
                                                Viết đánh giá
                                            </Button>
                                        ) : (
                                            <ReviewForm
                                                productId={productId}
                                                userId="user2" // In a real app, this would be the current user's ID
                                                userName="Nguyễn Văn A" // In a real app, this would be the current user's name
                                                verified={true} // In a real app, this would be determined by checking if the user has purchased the product
